...
const GITHUB_REPO = 'newcodebook/xoaai'
// GHCR image published by CI (tags carry no "v" prefix, e.g. ghcr.io/newcodebook/xoaai:0.1.146)
const DOCKER_IMAGE = 'ghcr.io/newcodebook/xoaai'
