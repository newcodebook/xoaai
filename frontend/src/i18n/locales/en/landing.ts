export default {
  ...
  products: {
    ...
    gpt: {
      name: 'ChatGPT',
      provider: 'OpenAI',
      desc: 'Industry-leading conversational and reasoning AI. Latest GPT and o-series models.',
  ...
  pricing: {
    ...
    tableInput: 'Input',
    tableOutput: 'Output',
    tableNote: 'All prices in USD per 1M tokens, matching official provider rates.',
