...
func TestEmailQueueTasksPreserveLocaleHints(t *testing.T) {
	...
	require.NoError(t, queue.EnqueueVerifyCode("user@example.com", "XOAAI", "zh-CN"))
	require.NoError(t, queue.EnqueuePasswordReset("user@example.com", "XOAAI", "https://example.com/reset", "en-US"))
