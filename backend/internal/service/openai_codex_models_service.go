...
import (
	...
	"github.com/newcodebook/xoaai/internal/pkg/httpclient"
...
const (
	...
	configuredCodexCustomDescription   = "Custom model routed through XOAAI."
...
func newConfiguredCodexModelDescriptor(modelID string) configuredCodexModelDescriptor {
	...
	if isDeepSeekCodexModel(modelID) {
		...
		descriptor.Description = "DeepSeek coding and reasoning model routed through XOAAI."
	...
	if isGrokCodexModel(modelID) {
		...
		descriptor.Description = "Grok coding and reasoning model routed through XOAAI."
		descriptor.SupportsParallelToolCalls = true
	...
	if isClaudeCodexModel(modelID) {
		...
		descriptor.Description = "Claude coding and reasoning model routed through XOAAI."
		descriptor.SupportsParallelToolCalls = true
	...
	if isOpenAICodexGPTModel(modelID) {
		...
		descriptor.Description = "OpenAI GPT coding model routed through XOAAI."
		descriptor.SupportsParallelToolCalls = true
