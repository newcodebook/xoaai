#!/bin/bash
# =============================================================================
# XOAAI Docker Deployment Preparation Script
# =============================================================================
# This script prepares deployment files for XOAAI:
...
GITHUB_RAW_URL="https://raw.githubusercontent.com/newcodebook/xoaai/main/deploy"
...
main() {
    echo ""
    echo "=========================================="
    echo "  XOAAI Deployment Preparation"
    echo "=========================================="
    echo ""
    ...
    echo ""
    echo "  3. View logs:"
    echo "     docker-compose logs -f xoaai"
    echo ""
