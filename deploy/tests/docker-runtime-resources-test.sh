...
assert_line Dockerfile.goreleaser 'COPY --chown=xoaai:xoaai backend/resources /app/resources'
assert_line deploy/Dockerfile 'COPY --from=backend-builder --chown=xoaai:xoaai /app/backend/resources /app/resources'
